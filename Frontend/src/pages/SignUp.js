...
export default function SignUp() {
  ...
  return (
    <div className="text-center mt-[130px]">
        <h2 className='font-gilroy-bold text-[50px]'>Регистрация</h2>
        <h3 className='font-gilroy-bold text-[16px]'>Есть аккаунт? <a href='' className='underline text-main'>войдите в аккаунт</a></h3>
        <form onSubmit={submitChackin} >
            ...
            onChange={changeInputRegister}
            /></div>
            <input type="submit" className='mt-[30px] font-gilroy-bold text-[20px] text-white pl-[140px] pr-[140px] py-[21px] bg-main rounded-[15px] ml-[15px]' value="Зарегистрироваться"/>
        </form>
    </div>
  )
}
