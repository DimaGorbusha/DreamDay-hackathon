  ...
  return (
    <div className="flex mt-[91px]">
      <div className='flex flex-col items-center ml-[99px]'>
        ...
        <Link to='/articles' className='font-gilroy-bold text-[20px] pl-[20px] pt-[21px] pb-[21px] pr-[190px] mb-[34px] bg-main text-white rounded-[10px] '>Статьи</Link>
      </div>
      <div>
        <img src={articles} alt='' className='ml-[35px]' />
      </div>
    </div>
  )
}